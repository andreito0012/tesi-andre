...
Most of the days this ratio is close to the planned one, but not exactly on it and that gap is exacly what a manager has to explore, understand and explain. 
Explaining it is anything but trivial.
...
This is the exact scenario where a \ac{LLM} could be the right fit. A that model is capable of reading the numbers and turn it into praragraphs within seconds, replacing hours of manual assembly.
